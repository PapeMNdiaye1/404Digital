...
import ImageProject_6 from '../Style/Images/Infos/Event-41.jpg';
        ...
        <div id="Infos">
            <section className='AccueilBigProjectsSection'>
                ...
                <OneBigProject title={'Fix Challenge 2023'} image={ImageProject_3}
                    ...
                    color={'#000'} textcolor={'#f1f1f1'} theKey={1} The_Experience={false} The_Experience_Link={''} link={'/Articles_4'} side={'left'} />
...
professionnelle.`}
                ...
                <OneBigProject title={`Musée Théodore-Monod d'art africain`} image={ImageProject_1}
                    ...
                    color={'#000'} textcolor={'#f1f1f1'} theKey={3} The_Experience={false} The_Experience_Link={''} link={'/Articles_3'} side={'left'} />
                ...
                <OneBigProject title={'Manufactures Sénégalaises Des Arts Décoratifs de THIES'} image={ImageProject_4}
                    ...
                    color={'#000'} textcolor={'#f1f1f1'} theKey={4} The_Experience={false} The_Experience_Link={''} link={'/MSDAD-de-THIES'} side={'right'} />
                ...
                <OneBigProject title={'FORAFRICC 2023'} image={ImageProject_2}
                    ...
                    color={'#000'} textcolor={'#f1f1f1'} theKey={5} The_Experience={false} The_Experience_Link={''} link={'/FORAFRICC_2023'} side={'left'} />
                ...
                <OneBigProject title={'DAKAR, CZECH IT OUT 2023'} image={ImageProject_5}
                    ...
                    color={'#000'} textcolor={'#f1f1f1'} theKey={6} The_Experience={false} The_Experience_Link={''} link={'/CZECH_IT_OUT'} side={'right'} />
            </section>
        </div>
    );
}
